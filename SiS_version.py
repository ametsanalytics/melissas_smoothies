...
from snowflake.snowpark.context import get_active_session #NOT NEEDED for SiS
from snowflake.snowpark.functions import col
#import requests  -- not needed for SiS
import pandas as pd
...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        #NEED TO IMPORT DATA INTO SNOWFLAKE FOR SIS
